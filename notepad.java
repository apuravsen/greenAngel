...
public class notepad extends JFrame implements ActionListener,WindowListener
{
	...
	public notepad()
	{
		setTitle("Notepad Developed By :- Vishal Bhardwaj");
		setSize(600,400);
		setVisible(true);
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		if (e.getSource() == feat)
		{
			String msg = "WELCOME TO Notepad DEVELOPED BY Vishal Bhardwaj" + "\n" + "\n" + "Notepad is exactly identical to the 'NOTEPAD' provided by 'WINDOWS'" + "\n" + "\n" + "Email all queries to : bhardwaj.vishalNIT@outlook.com";
		...
		{
			JOptionPane.showMessageDialog(null,"Notepad Vs.1.1 Developed By Vishal Bhardwaj" + "\n" + "Email me at - bhardwaj.vishalNIT@outlook.com");
		}
